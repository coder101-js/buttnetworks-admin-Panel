    ...
    <div className="admin-grid">
      ...
      <main className="admin-main">
        ...
        <table>
          ...
          <tbody>
            <List
              height={400}               // Visible height of the table body
              itemCount={contactList.length}
              itemSize={120}             // Approx height of each row in px
              width="100%"
            >
              {({ index, style }) => (
                <tr style={style} key={contactList[index]._id || index}>
...
const ContactRow = ({ contact }) => {
  ...
  // show read-more toggle if message over threshold
  useEffect(() => {
